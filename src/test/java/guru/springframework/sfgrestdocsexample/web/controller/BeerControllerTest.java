...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                        .param("isCold", "yes") // dummy parameter
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andDo(document("v1/beer",
                        pathParameters(
                                parameterWithName("beerId").description("UUID fo desired beer to get.")),
                        requestParameters(
                        ...
                        responseFields(
                                ...
                                //When using responseFields or requestFields you are expected to document all fields, otherwise the test will fail.
                                //Alternatively you can use the ignored() method
                        )));
    }
